...
local function snip_node(desc, text, nodes)
   return l.sn(nil, l.fmta(text, nodes), u.desc(desc))
end
...
return {
   ...
   l.s({
   ...
   }, l.c(1,
      {
         snip_node("If", bodies.if_regular, {
            if_condition = l.i(1, "True"), if_body = l.i(2, "pass")
         }),
         ...
         snip_node("If/elif/else", bodies.if_elif_else, {
            if_condition = l.i(1, "True"), if_body = l.i(2, "pass"),
            elif_condition = l.i(3, "False"), elif_body = l.i(4, "pass"),
   ...
   l.s({
      ...
      element = l.i(2, "element"), elements = l.i(1, "elements"), body = l.i(3, "pass")
   })),
